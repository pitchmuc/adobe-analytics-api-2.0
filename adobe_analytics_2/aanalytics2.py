...
def getReportSuites(txt: str = None, rsid_list: str = None, limit: int = 100, extended_info: bool = False,
...
def getSegments(name: str = None, tagNames: str = None, inclType: str = 'all', rsids_list: list = None,
                sidFilter: list = None, extended_info: bool = False, json_format=False, save: bool = False, **kwargs) -> object:
    """
...
def getCalculatedMetrics(name: str = None, tagNames: str = None, inclType: str = 'all', rsids_list: list = None,
